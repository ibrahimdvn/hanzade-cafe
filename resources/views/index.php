                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><span class="dropdown-item-text text-muted">
                            <i class="fas fa-envelope me-2"></i><?php echo htmlspecialchars(Auth::email()); ?>
                        </span></li>
                        <li><span class="dropdown-item-text text-muted">
                            <i class="fas fa-user-tag me-2"></i><?php echo ucfirst(Auth::role()); ?>
                        </span></li>
    ...
    <div class="container mt-4">
            ...
            <div class="col-md-3">
                <div class="card stats-card">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mb-0"><?php echo $products->num_rows; ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white;">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mb-0"><?php echo $categories->num_rows; ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white;">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mb-0">₺<?php echo number_format($totalStockValue, 2); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-boxes me-2"></i>Ürün Listesi
                </h5>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo $statusClass; ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="badge category-badge" style="background-color: <?php echo $row['category_color']; ?>;">
                                        <?php echo htmlspecialchars($row['category_name']); ?>
                                    </span>
                                    <?php else: ?>
                                    <span class="badge bg-secondary category-badge">Kategorisiz</span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
